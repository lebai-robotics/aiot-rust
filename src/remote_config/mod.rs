...
use serde::Serialize;
use crate::remote_config::recv::*;
use crate::remote_config::push::*;
use enum_iterator::IntoEnumIterator;

pub mod push;
pub mod recv;

type Recv = RemoteConfigRecv;
type RecvKind = RemoteConfigRecvKind;

impl crate::MqttClient {
	pub fn remote_config(&mut self) -> Result<HalfRunner> {
